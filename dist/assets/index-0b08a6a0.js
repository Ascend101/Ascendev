...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qt,depthTest:!1,depthWrite:!1})}function Gs(){return new xn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ir(),fragmentShader:`
		...
		`,blending:Qt,depthTest:!1,depthWrite:!1})}function Hs(){return new xn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ir(),fragmentShader:`
...
`].filter(ei).join(`
`)),o=wr(o),o=Zs(o,t),o=$s(o,t),a=wr(a),a=Zs(a,t),a=$s(a,t),o=Js(o),a=Js(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(A=`#version 300 es
